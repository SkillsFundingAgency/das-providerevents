...
{
    [TestFixture]
    public class RequestingSubmissionEventsByUln
    {
        [Test]
        public async Task ThenTheEventDataIsCorrect()
        {
            ...
            // normal fields
            //CollectionAssert.AreEqual(TestData.SubmissionEvents.Select(e => e.AcademicYear), events.Select(e => e.AcademicYear), "Checking AcademicYear");
