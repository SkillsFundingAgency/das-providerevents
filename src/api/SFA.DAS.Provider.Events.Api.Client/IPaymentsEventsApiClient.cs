...
namespace SFA.DAS.Provider.Events.Api.Client
{
    public interface IPaymentsEventsApiClient
    {
        ...
        /// <param name="courseType"> The course type to filter by</param>
        /// <returns>A task that yields a page of payments</returns>
        Task<PageOfResults<Payment>> GetPayments(string periodId = null, string employerAccountId = null, int page = 1, long? ukprn = null, int? courseType = null);
        ...
        Task<PaymentStatistics> GetPaymentStatistics(int? courseType = null);
    }
}